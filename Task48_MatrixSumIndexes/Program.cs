...
int[,] CreateMatrixySumIndexes(int rows, int colums) // Для двумерного массива в сигнатуре указываются строки rows и столбцы colums.
...
int[,] array2d = CreateMatrixySumIndexes(3, 4);
PrintMatrix(array2d);